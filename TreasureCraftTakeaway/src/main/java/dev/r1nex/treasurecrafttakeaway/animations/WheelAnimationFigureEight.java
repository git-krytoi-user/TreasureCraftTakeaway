...
public class WheelAnimationFigureEight {
    ...
    public WheelAnimationFigureEight(TreasureCraftTakeaway plugin, YamlConfiguration yamlConfiguration, double radiusRotation,
        ...
        async(() -> new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (int entityIds : plugin.getEntityIds()) {
                    double x = radiusRotation * Math.sin(angle);
                    double y = -radiusRotation * Math.sin(angle) * Math.cos(angle);
    ...
    public void async(Runnable runnable) {
        Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> {
            synchronized (WheelAnimationFigureEight.this) {
                runnable.run();
            }
        });
    }
